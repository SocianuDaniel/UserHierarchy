...
class CreateOwnerForm(forms.Form):
    ...
    password1  = forms.CharField(help_text=_('password'), max_length=16, widget=forms.PasswordInput())
    password2 =forms.CharField(help_text=_('password confirmation'), max_length=16, widget=forms.PasswordInput())
